...
const exercises = [
  {
    ...
    description: "AI-guided breathing technique to calm your nervous system.",
...
function BreathingStepCircle({ timer, step, isStarted, onStart }: any) {
    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      >
        <h1 className="text-3xl font-extrabold mb-4 tracking-tight text-center text-gray-900 dark:text-gray-100">
          AI-Powered Anxiety Relief
        </h1>
        
        <nav className="flex justify-center mb-7 space-x-2">
        ...
        <p className="mb-8 mt-2 text-center text-base text-gray-700 dark:text-gray-300">
        ...
        {isBreathing && (
          <section className="mb-6">
            ...
            <div className="text-center mb-2 text-base mt-4">
              {isBreathingStarted ? breathingSteps[breathStep].instruction : "Press Start to begin the AI-guided exercise."}
            </div>
            {isBreathingStarted && (
              <div className="flex flex-col items-center">
                <div className="flex justify-center gap-6 mt-2">
                  <button
                    className="px-4 py-2 rounded bg-blue-100 hover:bg-blue-200 text-blue-900 font-semibold shadow transition"
                    onClick={() => {
                      clearInterval(intervalRef.current)
                  ...
                  <button
                    className="px-4 py-2 rounded bg-yellow-100 hover:bg-yellow-200 text-yellow-600 font-semibold shadow transition"
                    onClick={handlePause}
                  >
        ...
        {isGrounding && (
          <section className="mb-4">
            <label className="font-medium mb-2 text-lg block text-gray-900 dark:text-gray-100">
            ...
            {(groundingResponses[groundStep] && groundingResponses[groundStep].trim() !== "") && (
              <span className="inline-block ml-2 text-green-600 animate-bounce">✓</span>
            )}
